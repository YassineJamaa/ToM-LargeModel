...
def parse_arguments():
    ...
    parser.add_argument("--n_bootstrap", type=int, default=200, help="Bootstraping Dataset")
    parser.add_argument("--saving_interval", type=int, default=10, help="Saving Interval")
...
def main():
    ...
    bootstrap_canvas = benchmark_config[benchmark_name](subset=None)
    data = bootstrap_canvas.data.copy()
    json_file = os.path.join("Result", "BOOTSTRAP_ANALYSIS", model_name, f"{type(bootstrap_canvas).__name__}_{percentage:.2%}.json")
