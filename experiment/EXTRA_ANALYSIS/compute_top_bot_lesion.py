...
def parse_arguments():
    ...
    parser.add_argument("--method", type=str, default="revised", choices=["revised", "initial"] , help="Either: MD or ToM or language")
...
def main():
    ...
    for benchmark_name in benchmark_names:
            ...
            json_file = os.path.join("Result", "Final-Analysis", "ADDITIONAL-ANALYSIS", f"{method}", f"BOTH_TAILS_MASK_{localizer}", model_name, f"{benchmark_name}_top_lesion.json")
            ###############################################################
            ...
            for percentage in percentages:
                mask = get_masked_both_tails(loc, percentage)
